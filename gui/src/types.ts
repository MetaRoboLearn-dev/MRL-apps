...
export const Stickers: Record<Sticker, StickerData> = {
  ...
  [Sticker.HOUSE_GREEN]: { key: 'HOUSE_GREEN', image: GRAD('house_green.webp') },
  [Sticker.HOUSE_RED]: { key: 'HOUSE_RED', image: GRAD('house_red.webp') },
  [Sticker.HOUSE_RED_SANTA]: { key: 'HOUSE_RED_SANTA', image: BOZ('house_red_santa.webp') },
  [Sticker.HOUSE_BLUE]: { key: 'HOUSE_BLUE', image: GRAD('house_blue.webp') },
  [Sticker.HOUSE_YELLOW]: { key: 'HOUSE_YELLOW', image: GRAD('house_yellow.webp') },
  [Sticker.POST_OFFICE]: { key: 'POST_OFFICE', image: GRAD('post_office.webp') },
  [Sticker.RESTAURANT]: { key: 'RESTAURANT', image: GRAD('restoraunt.webp') },
  [Sticker.WAREHOUSE]: { key: 'WAREHOUSE', image: GRAD('warehouse.webp') },
  [Sticker.ELF_WORKSHOP]: { key: 'ELF_WORKSHOP', image: BOZ('elf_workshop.webp') },
